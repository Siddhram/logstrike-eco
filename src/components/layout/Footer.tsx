    ...
    <footer className="bg-gray-100 pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">AI Chip Store</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/deals" className="text-gray-600 hover:text-gray-900">Special Deals</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/warranty" className="text-gray-600 hover:text-gray-900">Warranty Information</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">© {new Date().getFullYear()} AI Chip Store. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link href="/sitemap" className="text-gray-600 hover:text-gray-900 text-sm">Sitemap</Link>
            </div>
          </div>
        </div>
      </div>
